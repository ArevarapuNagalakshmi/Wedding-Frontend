...
const MyBookings = () => {
  ...
  const sidebarLinks = [
    { label: "Browse Services", to: "/customer/services", description: "Discover vendor services and packages" },
    { label: "Saved Vendors", to: "/customer/saved-vendors", description: "Your shortlist of trusted vendors" },
    { label: "My Profile", to: "/customer/profile", description: "Edit your wedding preferences" },
    { label: "Billing", to: "/customer/billing", description: "Manage payments and invoices" },
  ];

  return (
    <div className="dashboard-container customer-dashboard-page page-with-sidebar">
      <Sidebar title="Account" links={sidebarLinks} />
